...
import UIKit
import Foundation
typealias JMAlertViewClickButtonBlock = ((_ alertView:JMAlertView,_ buttonIndex:Int)->Void)?

enum JMAlertAnimationOptions {
    case none
...
class JMAlertView : UIView{
    
    // MARK: - Public Property
    public var delegate : JMAlertViewDelegate?//weak
    public var animationOption:JMAlertAnimationOptions = .none
    // background visual
    ...
    private var _clickButtonBlock:JMAlertViewClickButtonBlock
    ...
    public convenience init(title:String,message:String?,delegate:JMAlertViewDelegate?,cancelButtonTitle:String?,otherButtonTitles:[String]){
    ...
    open class func show(title:String,message:String?,cancelButtonTitle:String?,otherButtonTitles:String ... ,clickButtonBlock:JMAlertViewClickButtonBlock){
        let alertView = JMAlertView(title: title, message: message, delegate: nil, cancelButtonTitle: cancelButtonTitle, otherButtonTitles: otherButtonTitles)
        alertView._clickButtonBlock = clickButtonBlock
        alertView.show()
    }
    
    open class func show(title:String,message:String?,cancelButtonTitle:String?,otherButtonTitle:String,clickButtonBlock:JMAlertViewClickButtonBlock){
        
        let alertView = JMAlertView(title: title, message: message, delegate: nil, cancelButtonTitle: cancelButtonTitle, otherButtonTitles: [otherButtonTitle])
        alertView._clickButtonBlock = clickButtonBlock
        alertView.show()
    }
